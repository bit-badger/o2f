...
other, but we have yet to tell the compiler about them, or how they should be ordered. Back in `Tres.fsproj`, modify the
`ItemGroup` that has a `<Compile Include="Program.fs" />`, to look like the following:
